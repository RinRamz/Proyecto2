...
namespace Ninja
{
    public class EnemyTankStateManager : MonoBehaviour
    {
        ...
        private EnemyTankStateManager _stateManager = default;
        private EnemyTankBaseState _currentState = default;
        private EnemyTankStateFactory _states = default;
        ...
        [SerializeField] private GameObject _enemyBaby = default;
        [SerializeField] private Transform _enemyBabySpawnPoint = default;
        ...
        //Getters and Setters 
        public EnemyTankBaseState CurrentState { get { return _currentState; } set { _currentState = value; } }
        public GameObject CritText => _critText;
        public GameObject EnemyBaby => _enemyBaby;
        public EnemyManager EnemyActions => _enemyActions;
        public EnemyTankStateManager StateManager => _stateManager;
        ...
        private void Awake()
        {
            ...
            _states = new EnemyTankStateFactory(this);
        ...
        public void EnemyBabyInstantation()
        {
            Instantiate(_enemyBaby, _enemyBabySpawnPoint.position, Quaternion.identity);
        }
    }
}
